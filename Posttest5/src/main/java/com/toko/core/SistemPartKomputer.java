...
import com.toko.model.GPU;
import com.toko.model.Processor;
import com.toko.model.RAM;
...
public class SistemPartKomputer {
    ...
    void main() {
        listPart.add(new Processor("Intel i9 14900KF", 5, 7950000, "LGA 1700"));
        ...
        do {
            ...
            System.out.println("| 8. Lihat Laporan Transaksi Besar                      |");
    ...
    void laporanTransaksiBesar() {
        System.out.print("\nMasukkan minimal total transaksi (Rp): ");
        double min = 0;
        if (input.hasNextDouble()) min = input.nextDouble();
        input.nextLine();

        new Laporan().cetakLaporan(riwayatTransaksi, min);
    }
